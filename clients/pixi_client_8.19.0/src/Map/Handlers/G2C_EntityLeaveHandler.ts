...
export class G2C_EntityLeaveHandler implements ClientMessageHandler<MapWorld, G2C_EntityLeave> {
  handle(world: MapWorld, message: G2C_EntityLeave): void {
    world.leave(message.unitId);
  }
}
