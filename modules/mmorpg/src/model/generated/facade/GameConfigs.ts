...
import { ModuleConfigRegistry } from "#tiangz/core";
import { ActionType, SkillAutoAttackPolicy, SkillDelivery, SkillMovementPolicy, SkillTargetRelation, SpatialMode, Tables, type game } from "../config/schema";
...
export class GameConfigRegistry {
  ...
  static Install(manifestJson: string, dataJson: string): GameConfigInstallResult {
    ...
    const candidate: GameConfigSnapshot = Object.freeze({ ...CreateGameConfigTables(rawData), dataFingerprint: manifest.dataFingerprint, hotDataFingerprint: manifest.hotDataFingerprint, coldDataFingerprint: manifest.coldDataFingerprint });
  ...
  static RequireCurrent(): GameConfigSnapshot {
    ...
    if (installed && this.current?.dataFingerprint !== installed.dataFingerprint) {
      this.current = Object.freeze({ ...CreateGameConfigTables(installed.tables), dataFingerprint: installed.dataFingerprint,
        hotDataFingerprint: installed.dataFingerprint, coldDataFingerprint: "52ce790044f8fbc788dddceda42641b1cb4f6452caa4d6acc3f27dcca8e45d82" });
    }
...
export class GameConfigs {
  static get ItemConfig() { return GameConfigRegistry.RequireCurrent().ItemConfig; }
  static get BuffConfig() { return GameConfigRegistry.RequireCurrent().BuffConfig; }
  static get MapConfig() { return GameConfigRegistry.RequireCurrent().MapConfig; }
  static get PlayerConfig() { return GameConfigRegistry.RequireCurrent().PlayerConfig; }
  static get AoiConfig() { return GameConfigRegistry.RequireCurrent().AoiConfig; }
  static get AoiSyncTierConfig() { return GameConfigRegistry.RequireCurrent().AoiSyncTierConfig; }
  static get MonsterConfig() { return GameConfigRegistry.RequireCurrent().MonsterConfig; }
  static get MonsterAreaConfig() { return GameConfigRegistry.RequireCurrent().MonsterAreaConfig; }
  static get DropTableConfig() { return GameConfigRegistry.RequireCurrent().DropTableConfig; }
  static get SkillConfig() { return GameConfigRegistry.RequireCurrent().SkillConfig; }
  static get SkillEffectConfig() { return GameConfigRegistry.RequireCurrent().SkillEffectConfig; }
  static get QuestConfig() { return GameConfigRegistry.RequireCurrent().QuestConfig; }
  static get QuestObjectiveConfig() { return GameConfigRegistry.RequireCurrent().QuestObjectiveConfig; }
}

function validateSnapshot(snapshot: GameConfigTables): void {
...
export function CreateGameConfigTables(rawData: Readonly<Record<string, unknown>>): GameConfigTables {
    ...
    const candidate: GameConfigTables = Object.freeze({
