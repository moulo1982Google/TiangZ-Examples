...
import type { IActorLocationRequest, IActorLocationResponse, IRequest, IResponse } from "../../../../../../../../../TiangZ/app/core/protocol/message";

export interface B2B_RuntimePingRequest extends IRequest {
  rpcId?: number;
  seq: number;
  delayMs: number;
}

export const B2B_RuntimePingRequestCodec = {
  decode(payload: Uint8Array): B2B_RuntimePingRequest {
    const reader = new BinaryReader(payload);
    const value: B2B_RuntimePingRequest = {
      seq: 0,
      delayMs: 0,
    };
    while (!reader.eof()) {
  ...
  encode(value: B2B_RuntimePingRequest): Uint8Array {
...
export interface B2B_RuntimePingResponse extends IResponse {
  message?: string;
  error?: number;
  rpcId?: number;
  seq: number;
...
export const B2B_RuntimePingResponseCodec = {
  decode(payload: Uint8Array): B2B_RuntimePingResponse {
    const reader = new BinaryReader(payload);
    const value: B2B_RuntimePingResponse = {
      seq: 0,
      serverConcurrency: 0,
    };
    while (!reader.eof()) {
      ...
      if (tag.fieldNo === 92 && tag.wireType === 2) {
        ...
        value.serverConcurrency = reader.uint32();
      }
      else {
        reader.skip(tag.wireType);
      }
  ...
  encode(value: B2B_RuntimePingResponse): Uint8Array {
    const writer = new BinaryWriter();
    if (value.message !== undefined) writer.string(92, value.message);
    if (value.error !== undefined) writer.uint32(91, value.error);
    if (value.rpcId !== undefined) writer.uint32(90, value.rpcId);
    if (value.seq !== undefined) writer.uint32(1, value.seq);
    if (value.serverConcurrency !== undefined) writer.uint32(2, value.serverConcurrency);
    return writer.finish();
  },
};
